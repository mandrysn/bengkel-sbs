...
class AsuransiController extends Controller
{
    ...
    public function index()
    {
        $title = 'Asuransi';
        $route = 'asuransi';
        $asuransi = Asuransi::orderby('created_at', 'desc')->paginate(10);
        
        return view('asuransi.index', compact('title', 'asuransi', 'route'));
    }
    ...
    public function cari(Request $request)
    {
        ...
        $asuransi = Asuransi::where('nama_asuransi', 'LIKE', '%' . $kata_kunci . '%')
