...
class BuktiKeluarDetailController extends Controller
{
    /**
    ...
    public function destroy($id)
    {
        ...
        $data = BuktiKeluarDetail::findOrFail($id);
        $data->delete();
        ...
        $bbm = BuktiMaterialDetail::findOrFail($data->bukti_material_detail_id);
        $bbm->bm_quantity += $data->bk_quantity;
        $bbm->update();
        
        $transaksi = BuktiKeluar::findOrFail($data->bukti_keluar_id);
        ...
        return redirect('bukti-keluar/'. $data->bukti_keluar_id .'/edit/');
    }
}
