          ...
          <div class="col-md-6">
            <h4>Data Transaksi</h4>
                ...
                <table class="table" width="50%">
                    <tr><th class="left" width="30%">Nomor Barang Keluar</th><td width="1%">:</td><td>{{ $sot->bbk_transaksi }}</td></tr>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border">{{ $data->barang->nama_barang }} / {{ $data->barang->no_part_barang }}</td>
                        <td class="border">{{ $data->suplier->nama_suplier }}</td>
                        <td class="border">{{ $data->bk_quantity }} {{ $data->barang->satuan->kode_satuan }}</td>
                        <td class="border">
                ...
                <tfoot>
                    <tr>
                        <td colspan="5" class="border" align="right" valign="middle"><h5>total (Rp)</h5></td>
