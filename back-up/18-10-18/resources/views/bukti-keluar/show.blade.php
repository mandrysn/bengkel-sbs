	  ...
	  #gambar {
		...
		margin-bottom: 5px;
            ...
            <h1 class="page-header">
                ...
                <span>Bukti Keluar Bengkel {{ $title }}</span>
            </h1>
            <div class="col-md-6">
                <h2>Data Transaksi</h2>

                <table class="table" width="50%">
                    <tr><th width="30%">Nomor Barang Keluar Pribadi</th><td width="1%">:</td><td>{{ $sot->bbk_material }}</td></tr>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <p></p>
                        {!! Form::open(
                                        ['route' => ['print-bukti-keluar.store'], 
                                            'role'  => 'form',
                                            'method'=> 'post',
                                            'class' => 'form-inline']) !!}
