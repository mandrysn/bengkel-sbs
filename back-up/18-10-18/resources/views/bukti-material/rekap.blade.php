...
<body>
    <span>Bukti Barang Masuk - Pengajuan Pembayaran</span>
    <table>
            <tr class="yellow"> 
                <td class="nomor">
                    No
                ...
                <td class="no" align="center">
                    No. Bukti Barang Masuk
                </td>
                <td class="no" align="center">
                    No. Pengajuan Pembayaran
                </td>
                <td class="no" align="center">
                        Biaya
                    </td>
            ...
            @endforeach
            <tr>
                    <td colspan="4" class="adjacent">total</td>
