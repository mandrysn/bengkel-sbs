...
<html lang="en">
    ...
    <body>
            ...
            <div style="margin-top: -18px">
                ...
                <table width="100%">
                            <tr>
                                <th  class="border center" width="4%">No</th>
                                <th class="border center" width="11%">Nomor Polisi</th>
                                <th class="border center" width="19%">Nama Pemesan</th>
									<th class="border center" width="17%">Nomor Rangka</th>
									<th class="border center" width="17%">Nomor Mesin</th>
									<th class="border center" width="20%">Merek / Tipe</th>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="border" >{{ $data->sokendaraan->no_polisi }}</td>
                                <td class="border" >{{ $data->sokendaraan->sopelanggan->nama_pelanggan }}</td>
									<td class="border" >{{ $data->sokendaraan->no_rangka }}</td>
									<td class="border" >{{ $data->sokendaraan->no_mesin }}</td>
									<td class="border" >{{ $data->sokendaraan->merek->nama_merek }} / {{ $data->sokendaraan->merek->unit_merek }}</td>
        ...
        <table width="100%">
            <thead>
                <tr>
                    ...
                    <th class="border center" width="17%"><center>Data Pelanggan</center></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border">{{ $data->sokendaraan->sopelanggan->nama_pelanggan }} [{{ $data->sokendaraan->no_polisi }}]</td>
