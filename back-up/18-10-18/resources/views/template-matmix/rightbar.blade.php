                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="coversetaion">
                        ...
                        <div class="block-content chat-user-list">
                            ...
                            <ul class="chat-list">
                                <li>
                                    <a href="#"><span class="chat-avatar"><img src="{{asset('admin/matmix/images/avatar/adellecharles.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Adellecharles<cite>New York</cite></span></a>
                                    <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                                </li>
                                <li class="chat-u-online">
                                    <a href="#"><span class="chat-avatar"><img src="{{asset('admin/matmix/images/avatar/allisongrayce.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Allisongrayce<cite>New York</cite></span></a>
                                    <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                                </li>
                            </ul>
                            ...
                            <ul class="chat-list">
                                <li>
                                    <a href="#"><span class="chat-avatar"><img src="{{asset('admin/matmix/images/avatar/geeftvorm.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Geeftvorm<cite>New York</cite></span></a>
                                    <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                                </li>
                                <li class="chat-u-online">
                                    <a href="#"><span class="chat-avatar"><img src="{{asset('admin/matmix/images/avatar/amarkdalen.jpg')}}" alt="Avatar"></span><span class="chat-u-info">Amarkdalen<cite>New York</cite></span></a>
                                    <span class="chat-u-status"><i class="fa fa-circle"></i></span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="block-content">
                            <div class="aside-notifications-wrap">
                                <div class="message-wrap">
                                    ...
                                    <ul class="clearfix">
                                        <li class="clearfix">
                                            <a href="#" class="message-thumb"><img src="{{asset('admin/matmix/images/avatar/adellecharles.jpg')}}" alt="image">
                                        ...
                                        <li class="clearfix">
                                            <a href="#" class="message-thumb"><img src="{{asset('admin/matmix/images/avatar/allisongrayce.jpg')}}" alt="image">
                                        ...
                                        <li class="clearfix">
                                            <a href="#" class="message-thumb"><img src="{{asset('admin/matmix/images/avatar/coreyweb.jpg')}}" alt="image">
