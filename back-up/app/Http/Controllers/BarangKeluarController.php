...
class BarangKeluarController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $bbm = BarangMasukDetail::findOrFail($request->id);
                ...
                $item = BarangKeluarDetail::firstOrCreate([
                    ...
                    'harga_transaksi' => $bbm->barang->harga_jual,
                    'barang_id'       => $bbm->barang_id,
                    'diskon'          => $bbm->potransaksibarang->sotransaksibarang->diskon,
    ...
    public function edit($id)
    {
        ...
        $barang = BarangMasukDetail::where('quantity', '>', 0)
    ...
    public function cari(Request $request)
    {
        ...
        $title = 'Barang Keluar - Pencarian ' . $kata_kunci;
        $route = 'barang-keluar';
        ...
        return view('barang-keluar.index', compact('title', 'order', 'route'));
    }
    ...
    public function pdfview($id)
    {
        ...
        return $pdf->setPaper('f4')->download('BBM-'.$sot->bbk_transaksi.'.pdf');
    }
}
