...
class EkstimasiBarangController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // $barang = Barang::findOrFail($request->so_transaksi_barang_id)->first();
        //     if (SoTransaksiBarang::where('so_transaksi_id', $request->so_transaksi_id)->where('barang_id', $request->so_transaksi_barang_id)->get()->count() == 0) {
        //         SoTransaksiBarang::firstOrCreate([
        //             'so_transaksi_id'    => $id,
        //             'kategori_transaksi' => '2',
        //             'barang_id'          => $request->so_transaksi_barang_id,
        //             'diskon'             => $request->barang_diskon,
        //             'keterangan_transaksi' => $request->keterangan_transaksi,
        //             'harga_transaksi'    => $barang->harga_jual
        //         ]);
        //     } else {
        //         $transaksi_barang = SoTransaksiBarang::findOrFail($request->so_transaksi_id);
