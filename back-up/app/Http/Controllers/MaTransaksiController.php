...
class MaTransaksiController extends Controller
{
    ...
    public function index()
    {
        ...
        $title = 'Pemesanan Barang Pribadi';
        $route = 'order-material';
        
        $order_material = Material::where('ma_transaksi', 'LIKE', '%-PO/MA%')->orderby('created_at', 'asc')->paginate(20);
        
        return view($route . '.index', compact('title', 'order_material', 'route'));
    }
    ...
    public function create()
    {
        ...
        $route   = 'order-material';
        $title   = 'Tambah Pemesanan Pribadi';
        $button  = 'Tambah';
    ...
    public function show($maTransaksi)
    {
        ...
        $route  = 'order-material';
        $title  = 'Detail Pemesanan Pribadi';
    ...
    public function pdfview($id)
    {
        ...
        $title     = 'Pemesanan Pribadi No. ' . $transaksi->ma_transaksi;
        ...
        return $pdf->setPaper('a4')->download('MA-'.$transaksi->ma_transaksi.'.pdf');
    }
    ...
    public function cari(Request $request)
    {
        ...
        $title = 'Pemesanan Barang Pribadi - Pencarian ' . $kata_kunci;
        $route = 'order-material';
        
        $order_material = Material::where('ma_transaksi', 'LIKE', '%' . $kata_kunci . '%')->orderby('created_at', 'asc')->paginate(20);
