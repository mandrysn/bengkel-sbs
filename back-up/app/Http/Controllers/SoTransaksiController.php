...
class SoTransaksiController extends Controller
{
    ...
    public function create()
    {
        ...
        // $pre_so  = SoTransaksi::where('status', 1)->pluck('no_transaksi', 'id')->all();
    ...
    public function cari(Request $request)
    {
        ...
        $title = 'Servis Order - Pencarian ' . $kata_kunci;
        $route = 'servis-order';
    ...
    public function pdfview($id)
    {
        ...
        $title     = 'Servis Order No. ' . $transaksi->no_transaksi;
        
        $pdf = PDF::loadview('servis-order.print', compact('transaksi', 'details', 'gantis', 'title'));
        // return view('pre-so.print');
        return $pdf->setPaper('f4')->download('Servis-Order-'.$transaksi->no_transaksi.'.pdf');
    }
}
