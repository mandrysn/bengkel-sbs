...
class TagihanController extends Controller
{
    ...
    public function index()
    {
        ...
        $title    = 'Invoice';
        $route = 'tagihan';
        $tagihans = Tagihan::orderby('tanggal_masuk', 'asc')->paginate(20);
        ...
        return view($route . '.index', compact('title', 'route', 'totalb', 'totalj', 'totalm', 'tagihans'));
    }
    ...
    public function cari(Request $request)
    {
        ...
        $tagihans = Tagihan::where('kode_tagihan', 'LIKE', '%' . $kata_kunci . '%')
