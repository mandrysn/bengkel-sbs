                <div class="form-group{{ $errors->has('kode_suplier') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('kode_suplier', null, ['class' => 'form-control', 'placeholder' => 'Kode Supplier', 'autofocus']) }}
                ...
                <div class="form-group{{ $errors->has('nama_suplier') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('nama_suplier', null, ['class' => 'form-control', 'placeholder' => 'Nama Supplier']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('no_hp_suplier', null, ['class' => 'form-control', 'placeholder' => 'No. Hp Supplier']) }}
                    </div>
                </div>
