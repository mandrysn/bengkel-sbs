                                            ...
                                            <div role="menu" class="dropdown-menu message-dropdown msg-lists fadeInUp hide-small-device">
                                                <div class="message-wrap">
                                                    ...
                                                    <ul class="clearfix">
                                                        ...
                                                        <li class="clearfix">
                                                            <a href="#" class="message-thumb"><img src="{{asset('admin/matmix/images/avatar/bobbyjkane.jpg')}}" alt="image">
                                        ...
                                        <ul>
                                            <li class="dropdown">
                                                <a data-toggle="dropdown" href="#" class="clearfix dropdown-toggle waves-effect waves-block waves-classic">
                                                    ...
                                                    <span class="user-thumb"><img src="{{asset('admin/matmix/images/avatar/jaman.jpg')}}" alt="image"></span>
                                                </a>
