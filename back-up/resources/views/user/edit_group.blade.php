...
<div class="form-group">
	<?php echo lang('edit_group_name_label', 'group_name',' class="col-lg-2 control-label"');?>
	<div class="col-lg-3">
...
<div class="form-group">
	<?php echo lang('edit_group_desc_label', 'description',' class="col-lg-2 control-label"');?>
	<div class="col-lg-3">
