...
class BarangMasukController extends Controller
{
    ...
    public function create()
    {
        ...
        $route   = 'barang-masuk';
        $title   = 'Tambah Bukti Purchase Order Masuk';
    ...
    public function show($id)
    {
        ...
        return view($route . '.show', compact('route', 'sot', 'sob', 'dbm', 'barang'));
    }
    ...
    public function edit($id)
    {
        ...
        $route  = 'barang-masuk';
        $title  = 'Edit Bukti Purchase Order Masuk';
        $button = 'Tambah';
    ...
    public function update(Request $request, $id)
    {
        ...
        $item = BarangMasukDetail::firstOrCreate([
            ...
            'keterangan_transaksi' => $suplier->keterangan_transaksi
        ]);
        ...
        $order = BarangMasuk::findOrFail($id);
    ...
    public function destroy($id)
    {
        ...
        $detail_barang = BarangMasukDetail::where('barang_masuk_id', $id)->get();
        ...
        Session::flash(
            "flash_notif",[
                ...
                "massage" => "Berhasil Mengapus Barang Masuk Purchase Order <strong>$sot->bbm_transaksi</strong>"
            ]);
    ...
    public function cari(Request $request)
    {
        ...
        $title = 'Bukti Purchase Order Masuk - Pencarian ' . $kata_kunci;
        $route = 'barang-masuk';
