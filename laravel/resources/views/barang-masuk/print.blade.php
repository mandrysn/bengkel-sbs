    ...
    <body>
          ...
          <div class="col-md-6">
            ...
            <table class="table" width="50%">
                <tr><th class="left" width="40%">Nomor Pemesanan Barang Masuk</th><td width="1%">:</td><td>{{ $sot->bbm_transaksi }}</td></tr>
                <tr><th class="left">Nomor Po Transaksi</th><td>:</td><td>{{ $sot->potransaksi->po_transaksi }}</td></tr>
            ...
            <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="border center">Biaya per Barang (Rp)</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td class="border" >{{ $data->bm_quantity }} /{{  $data->quantity }} {{ $data->barang->satuan->kode_satuan }}</td>
                                ...
                                <td class="border"  align="right">{{ number_format( $tagihan = ( $data->harga_transaksi - ($data->harga_transaksi * $data->diskon / 100) ) * $data->bm_quantity) }}{{ Form::hidden('total',  $total += $tagihan) }}</td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td  class="border adleft"  valign="middle">{{ number_format($total) }}</td>
                        </tr>
                    </tfoot>
                </table>
