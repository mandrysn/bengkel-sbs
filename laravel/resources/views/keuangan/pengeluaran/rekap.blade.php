...
<body>
    ...
    <table>
            ...
            <tr>
				...
				<td class="adjacent">
                    {{ $data->operasional->nama_operasional }}
                </td>
                <td class="adjacent">
                    {{ $data->ekterangan_transaksi }}
                </td>
                <td class="adjacent adleft">
                    {{ number_format($tagihan = $data->total_pengeluaran) }}{{ Form::hidden('total',  $total += $tagihan) }}
                </td>
            </tr>
            @endforeach
            <tr>
                    <td colspan="3" class="adjacent">total</td>
                    <td class="adjacent adleft">{{ number_format($total) }}</td>
                </tr>
    </table>
</body>
