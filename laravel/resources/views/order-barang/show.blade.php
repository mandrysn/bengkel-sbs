                    ...
                    <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
									...
									<td>{{ $data->sokendaraan->no_rangka }}</td>
									<td>{{ $data->sokendaraan->no_mesin }}</td>
	            ...
	            <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="right">{{ number_format( $tagihan = ( $data->barang->harga_beli - ($data->barang->harga_beli * $data->diskon / 100) ) * $data->po_quantity ) }}</td>
