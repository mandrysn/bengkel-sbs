                <div class="form-group{{ $errors->has('kode_asuransi') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('kode_asuransi', $kode, ['class' => 'form-control', 'placeholder' => 'Kode Asuransi', 'readonly']) }}
                ...
                <div class="form-group{{ $errors->has('nama_asuransi') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('nama_asuransi', null, ['class' => 'form-control', 'placeholder' => 'Nama Asuransi', 'autofocus']) }}
