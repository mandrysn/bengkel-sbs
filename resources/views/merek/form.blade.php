                <div class="form-group{{ $errors->has('kode_merek') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('kode_merek', $kode, ['class' => 'form-control', 'placeholder' => 'Kode Merek', 'readonly']) }}
                ...
                <div class="form-group{{ $errors->has('nama_merek') ? ' has-error' : '' }}">
                    ...
                    <div class="col-lg-3">
                        {{ Form::text('nama_merek', null, ['class' => 'form-control', 'placeholder' => 'Nama Merek', 'autofocus']) }}
