...
@section('content')
            ...
            <form class="form-horizontal" method="POST" action="{{ route('barang.update', $barang->id) }}">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="kode_barang" id="kode" placeholder="Kode Barang" value="{{ $barang->kode_barang }}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="nama" class="col-lg-2 control-label">No. Part Barang</label>
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="no_part_barang" id="nomor" placeholder="No Part Barang" value="{{ $barang->no_part_barang }}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="nama" class="col-lg-2 control-label">Nama Barang</label>
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="nama_barang" id="nama" placeholder="Nama Barang" value="{{ $barang->nama_barang }}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="nama" class="col-lg-2 control-label">Kategori Barang</label>
                    <select class="form-control selectpicker" name="kategori_barang" id="kategori" value="{{ $barang->kategori_barang }}" data-live-search="true">
                        <option></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" class="form-control" name="harga_barang" id="harga" placeholder="Harga Barang" value="{{ $barang->harga_barang }}" required>
                    </div>
                </div>
                <div class="form-group">
